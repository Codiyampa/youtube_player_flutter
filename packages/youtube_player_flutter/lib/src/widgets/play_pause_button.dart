...
class _PlayPauseButtonState extends State<PlayPauseButton>
  ...
  Widget build(BuildContext context) {
    ...
    return widget.bufferIndicator ?? ((Platform.isAndroid || !_controller.value.hasPlayed) &&
        ((!_controller.value.isReadyWithDelay && !_controller.value.hasPlayed) ||
                _controller.value.hasPlayed) && _controller.value.playerState != PlayerState.ended) ?
        Container(
          width: 30.0,
          height: 30.0,
